...
if TYPE_CHECKING:
    ...
    # Phase 26 Plan 03 schemas (now landed; the prior ``type: ignore[import-not-found]``
    # parallelization tripwire has fired and been removed -- Plan 03 merged via 6ae8a49).
