...
| **[Agent Queue Lanes](agent-queue-lanes.md)** | 🛤️ Per-lane file-server workers (analyze/meta/io), core budget + thread pinning, single-lane heartbeat, legacy-queue drain runbook |
