...
machine (`/Users/Robert/phaze-spike-audio`, `/Users/Robert/phaze-watch-test`):

| shim name | source | duration | bitrate | purpose |
| --------- | ------ | -------- | ------- | ------- |
| `track1_320` | `Marco_V_-_GODD_(T78_Extended_Remix).mp3` | 441.18 s | 365 kbps | single track |
...
| `set_79min` | `processed_mindtrick_timewarp.mp3` | 4 721.30 s | 320 kbps | full set |
| `set_79min_b` | byte-identical copy of `set_79min` (same md5) | 4 721.30 s | 320 kbps | exact-duplicate control |
| `set_368min` | `timedout_fearfm_hardcore_top100.mp3` | 22 098.51 s | 128 kbps | 6-hour concert recording |
...
{"has_more":false,"next_page":null,"provider_type":"navidrome","total_tracks":6,
 "tracks":[{"fp":"29622f9fdd628884","id":"71c97b1b-b78e-51dd-84a3-bbf6189c0f62"}, …]}

$ curl -s ':18000/external/get_embedding?id=71c97b1b-b78e-51dd-84a3-bbf6189c0f62'
item_id 71c97b1b-b78e-51dd-84a3-bbf6189c0f62   dim 200
```
...
2. **A mapping table records the provider's id per server.** Exactly what phaze needs:
   ...
   $ psql -c 'select item_id, provider_track_id, file_path from track_server_map'
    fp_44471493ab59320426a5…762e | 71c97b1b-b78e-51dd-84a3-bbf6189c0f62 | /data/music/original/track1_320.mp3
    fp_44671493ab59320426a5…762e | 97d017d0-e977-5c07-b0c1-bf83ce20f87c | /data/music/original/track1_192.mp3
    fp_44671493ab59321426a5…762e | dcd168c1-d3a8-54b4-849b-4d11c14edb22 | /data/music/original/track1_96.mp3
    fp_4c67149bab59320407a5…762a | 47f912ac-2d5a-52bc-b87c-69e3dc783b35 | /data/music/original/set_79min.mp3
    fp_44661c93a351320402a5…762e | f62ed50e-b9b7-5b0f-a857-44d813ea284c | /data/music/original/set_368min.mp3
   ```
...
```console
$ curl -s ':14040/__move'    # every file: /data/music/original/X -> /data/music/renamed/<rand>-X
$ curl -s -X POST :18000/api/analysis/start -d '{"num_recent_albums":0,"top_n_moods":5}'
...
$ psql -c 'select title, duration from score'
 GODD (T78 Extended Remix) [320]       | 441.1765     <- 7:21 track, real duration
 GODD (T78 Extended Remix) [192]       | 441.1765
 GODD (T78 Extended Remix) [96]        | 441.1765
 Mindtrick Timewarp (79 min set)       |      600     <- real duration 4 721 s
 FearFM Hardcore Top 100 (368 min set) |      600     <- real duration 22 099 s
```
