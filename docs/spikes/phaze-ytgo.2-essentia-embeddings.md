...
The measurements used `/Users/Robert/phaze-spike-models-full`. Every file was checked against the
...
| -- | ---- | -------- | --------------- | ---- |
| `W1` | `Disco19 - Images 20.04.23.mp3` | 301 s | mp3 320 kbps | individual track |
| `W2` | `The Doors - Riders On The Storm (DISCO19 Remix Edit).mp3` | 277 s | mp3 320 kbps | individual track |
| `W3` | `Disco19 - All Our Yesterdays EDIT [FINAL MASTER - 24bit].wav` | 257 s | wav 24-bit | individual track |
| `W4` | `Marco_V_-_GODD_(T78_Extended_Remix).mp3` | 441 s | mp3 ~365 kbps | individual track |
| `W5` | `Lauren Daigle - You Say (Ciaran McAuley Rework).wav` | 287 s | wav 24-bit | individual track |
| `W6` | `Lauren Daigle - You Say (Ciaran McAuley Extended Rework).wav` | 439 s | wav 16-bit | **same work as W5, different edit** |
| `S1` | `processed_mindtrick_timewarp.mp3` | 4 721 s (1 h 19 m) | mp3 320 kbps | **long set** |
| `S2` | `timedout_fearfm_hardcore_top100.mp3` | 22 098 s (6 h 08 m) | mp3 128 kbps | **long set** (top-100 countdown) |
