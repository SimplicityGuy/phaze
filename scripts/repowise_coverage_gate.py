...
end, and it exists because two of that path's failure modes are SILENT.
...
def check(coverage_status: dict[str, Any], index_status: dict[str, Any], expected_commit: str) -> list[str]:
...
def main(argv: list[str] | None = None) -> int:
    ...
    failures = check(coverage_status, index_status, args.expected_commit)
