...
<task type="auto">
  ...
  <verify>
    <automated>cd <scratch>/phaze/post-deploy-debug-2 && grep -q "revoked_at.is_(None)" src/phaze/routers/admin_agents.py && uv run mypy src/phaze/routers/admin_agents.py</automated>
  </verify>
...
<task type="auto">
  ...
  <verify>
    <automated>cd <scratch>/phaze/post-deploy-debug-2 && uv run pytest tests/agents/routers/test_admin_agents.py -x -q && uv run ruff check tests/agents/routers/test_admin_agents.py</automated>
  </verify>
