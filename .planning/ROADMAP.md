...
- [x] **Phase 17: Live Set Matching & Tracklist Review** - Scan live sets against fingerprint DB and display proposed tracklists for human review (completed 2026-04-02)
...
- [x] 17-02-PLAN.md -- Scan tab UI, source/status badges, proposed filter, scan endpoints
- [x] 17-03-PLAN.md -- Review flow: inline editing, approve/reject, bulk reject, fingerprint track detail
**UI hint**: yes
