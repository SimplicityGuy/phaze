...
**Plans**: 6 plans
- [ ] 25-01-PLAN.md — Schema foundation: Agent.last_status JSONB + migration 014 + conftest fixtures (Wave 1)
- [ ] 25-02-PLAN.md — Auth helper module (agent_auth.py) + AUTH-01/AUTH-04 tests (Wave 2)
...
| 25. Internal Agent HTTP API & Bearer Auth | v4.0 | 0/6 | Not started | - |
