...
- [x] 56-01-PLAN.md — LocalQueue probe backend: get_local_queue + non-fatal startup probe + degrade-safe Redis flag read (KDEPLOY-04, D-05/D-06)
- [x] 56-03-PLAN.md — Ephemeral k8s-lane Agents note + DEAD-suppression invariants (KDEPLOY-04, D-07)
- [x] 56-04-PLAN.md — K8s cluster-admin runbook (Kueue/RBAC/Secret manifests) + transport notes + homelab change-prompt (KDEPLOY-01, KDEPLOY-03, D-01/D-02/D-03)
