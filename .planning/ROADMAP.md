...
- [ ] **Phase 18: Unified Search** - Full-text search across files, tracklists, and metadata with faceted filtering
...
**Plans**: 2 plans
Plans:
- [ ] 18-01-PLAN.md — Database migration (FTS, GIN indexes) + search query service
- [ ] 18-02-PLAN.md — Search router, templates, nav bar update, integration tests
**UI hint**: yes
...
| 18. Unified Search | v3.0 | 0/2 | Planning | - |
