# Requirements Archive: v4.0 Distributed Agents

**Archived:** 2026-05-17
**Status:** SHIPPED

For current requirements, see `.planning/REQUIREMENTS.md` (created fresh for next milestone via `/gsd:new-milestone`).
