...
- **Runtime proof — empirically confirmed against the live v4.0.8 image (2026-06-10).** Rather than defer entirely, the fix was proven on `host-store` using a throwaway root container from `ghcr.io/simplicityguy/phaze:v4.0.8`:
